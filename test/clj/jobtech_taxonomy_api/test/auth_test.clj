...
(test/deftest ^:integration-unauthorized-access-public unauthorized-access-public
  (test/testing "unauthorized access to /v1/taxonomy/main/concept/types"
    (let [[status body] (util/send-request-to-json-service :get "/v1/taxonomy/main/concept/types")]
...
#_(test/deftest ^:integration-unauthorized-access-private unauthorized-access-private
...
;; this test needs some work
#_(test/deftest ^:integration-authorized-access-private authorized-access-private
...
;; this test needs some work
#_(test/deftest ^:integration-authenticated-and-unauthorized-access-private authenticated-and-unauthorized-access-private
